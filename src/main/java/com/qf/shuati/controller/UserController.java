package com.qf.shuati.controller;
...
import com.qf.shuati.constant.UserConstant;
import com.qf.shuati.domain.dto.user.UserLoginRequest;
import com.qf.shuati.domain.dto.user.UserRegisterRequest;
import com.qf.shuati.domain.entity.User;
import com.qf.shuati.domain.dto.user.UserAddRequest;
import com.qf.shuati.domain.dto.user.UserQueryRequest;
import com.qf.shuati.domain.dto.user.UserUpdateMyRequest;
import com.qf.shuati.domain.dto.user.UserUpdateRequest;
...
import static com.qf.shuati.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Boolean> addUserSignIn(HttpServletRequest request){
        //必须登录才能签到
        User loginUser = userService.getLoginUser(request);
        boolean result = userService.addUserSignIn(loginUser);
        return ResultUtils.success(result);
    }
